#!/usr/bin/env python3
"""
refactored/core/__init__.py
Pyics Core Domain: refactored
...
This module provides the public interface for the refactored domain,
...
# [EOF] - End of refactored domain __init__.py
