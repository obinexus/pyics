#!/usr/bin/env python3
"""
refactored/core/primitives/__pycache__/__init__.py
Pyics Core Domain: primitives
...
This module provides the public interface for the primitives domain,
...
# [EOF] - End of primitives domain __init__.py
