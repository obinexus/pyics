#!/usr/bin/env python3
"""
pyics/core/transforms/aggregation/__pycache__/__init__.py
Pyics Core Domain: transforms/aggregation
...
This module provides the public interface for the transforms/aggregation domain,
...
# Domain metadata
__domain__ = "transforms/aggregation"
__version__ = "1.0.0"
...
# [EOF] - End of transforms/aggregation domain __init__.py
