#!/usr/bin/env python3
"""
pyics/core/registry/global/relations.py
Pyics Core Domain Relations: registry/global
...
PROBLEM SOLVED: Centralized relationship mapping for registry/global domain
DEPENDENCIES: registry/global.data_types, typing, dataclasses
...
in the registry/global domain, following DOP principles with immutable
...
class RelationType(Enum):
    """Types of relationships in registry/global domain"""
    ONE_TO_ONE = auto()
    ONE_TO_MANY = auto()
    MANY_TO_MANY = auto()
    HIERARCHICAL = auto()
...
class Relation:
    """
    Immutable relation between registry/global entities
...
class RelationGraph:
    """
    Immutable graph of relations in registry/global domain
    
    Container for complete relationship structure
    """
    relations: Tuple[Relation, ...] = field(default_factory=tuple)
    entity_index: Dict[str, Registry/GlobalEntity] = field(default_factory=dict)
    ...
    def get_related_entities(self, entity_id: str) -> List[Registry/GlobalEntity]:
...
class RelationMapping:
    """
    Static mapping configuration for registry/global relations
...
# Predefined relation mappings for registry/global domain
DEFAULT_RELATION_MAPPINGS: List[RelationMapping] = [
    RelationMapping(
        mapping_name="hierarchical_parent_child",
        source_type="Registry/GlobalEntity",
        target_type="Registry/GlobalEntity",
...
# [EOF] - End of registry/global relations.py module
