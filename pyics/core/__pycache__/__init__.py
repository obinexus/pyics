#!/usr/bin/env python3
"""
pyics/core/__pycache__/__init__.py
Pyics Core Domain: core
...
This module provides the public interface for the core domain,
...
# [EOF] - End of core domain __init__.py
